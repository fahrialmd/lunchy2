...
entity OrderItems : cuid, managed {
    ...
    deliveryFee : Integer  @Core.Computed  @Semantics.amount.currencyCode: 'currency';
    discount    : Integer  @Core.Computed  @Semantics.amount.currencyCode: 'currency';
    overlimit   : Integer  @Core.Computed  @Semantics.amount.currencyCode: 'currency';
